    ...
    static async _blockToObj(block, includeTransactions = false) {
        ...
        return {
            ...
            transactions: includeTransactions
                ? block.transactions.map((tx, i) => _transactionToObj(tx, block, i))
